...
public class CreateInstructorDemo {
	...
	public static void main(String[] args) {
		...
		SessionFactory sf = new MetadataSources(registry).addAnnotatedClass(Instructor.class)
				.addAnnotatedClass(InstructorDetail.class).addAnnotatedClass(Course.class).buildMetadata().buildSessionFactory();
		Session session = sf.getCurrentSession();

		try {
			// create a student object
			System.out.println("Creating a new Instructor object..");
			Instructor instructor1 = new Instructor("Gamthi", "Khanna", "gamthi@gmail.com");
			InstructorDetail insD1 = new InstructorDetail("youtube.com/gamthi", "Tabla");
